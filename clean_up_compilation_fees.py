...
os.chdir(r'C:\Users\AnonAnon\Documents\Python Files\Dev\LR Migration\Migrate - All Files')
input_files = glob.glob('[!~]*.xlsx')         
input_files.pop()
input_files.remove('LRI_AH shares@2021 Q1 - duplicate of AHs.xlsx')
fund_import_file = 'C:/Users/AnonAnon/IT-Venture Ltd/Lion River - Documents/Import Files/ITV Import Files/04 Funds.xlsx'
...
for fee in comp_fees_sum.itertuples():
    ...
    if len(rel) == 1:
        ...
        # We'll need to replace the description with what's in the source data for these rows within Compilation_LR (C:\Users\AnonAnon\IT-Venture Ltd\Lion River - Documents\Data Migration\Investee Fund Operation Compilation Files\Returned by LR)
        print('------------------------------------------') 
...
comp_file = 'C:/Users/AnonAnon/IT-Venture Ltd/Lion River - Documents/Data Migration/Investee Fund Operation Compilation Files/Returned by LR/Compilation_LR.xlsx'
...
import openpyxl as oxl
import pandas as pd
input_file = 'C:/Users/AnonAnon/Documents/Python Files/Dev/LR Migration/Migrate - All Files/LRI_M shares@2021 Q1.xlsx'
file_name = 'M Shares' 
dst_rows = mig.compile_data(input_file, file_name)
dst_file = 'C:/Users/AnonAnon/Documents/Python Files/Dev/LR Migration/Migrated/LRI_AHp shares migrated.xlsx'      
