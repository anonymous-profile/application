...
dest_directory = r'C:\Users\AnonAnon\Documents\Python Files\Dev\LR Migration\Migrate These'
##############################################################################################################
...
def split_files_rhone():
    input_file = 'C:/Users/AnonAnon/IT-Venture Ltd/Lion River - Documents/LR Reports/Investee Funds/JV Rhone Performance (B-C-D- F-H-I-J-K-L-P-Q-S-T-X-Y) @2021 Q1.xlsx'
    xl = pd.ExcelFile(input_file)
